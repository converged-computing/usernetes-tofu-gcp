data "google_compute_image" "usernetes_compute_x86_64_image" {
...
locals {
    ...
    compute_images = {
        "x86-64" = {
            image   = data.google_compute_image.usernetes_compute_x86_64_image.self_link
            project = data.google_compute_image.usernetes_compute_x86_64_image.project
        }
    }
...
module "usernetes_compute_instance_template" {
...
module "usernetes_compute_instances" {
    ...
    instance_template   = module.usernetes_compute_instance_template.self_link
    subnetwork          = var.subnetwork
}
